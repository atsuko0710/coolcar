...
const (
	...
	TripStatus_NOT_STARED       TripStatus = 1
...
type Trip struct {
	...
	PathLocations []*Location `protobuf:"bytes,7,rep,name=path_locations,json=pathLocations,proto3" json:"path_locations,omitempty"` // 中间地点（多个）
...
var file_trip_proto_rawDesc = []byte{
	...
	0x5f, 0x53, 0x54, 0x41, 0x52, 0x45, 0x44, 0x10, 0x01, 0x12, 0x0f, 0x0a, 0x0b, 0x49, 0x4e, 0x5f,
	...
	0x24, 0x5a, 0x22, 0x63, 0x6f, 0x6f, 0x6c, 0x63, 0x61, 0x72, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65,
